...
> {
  ...
  /**
   * @mark Setting scroll mode to 1 which stands for horizontal scrolling.
   */
  init() {
  ...
  onDocumentReady = () => {
    ...
    const event = new Event('pagesinit');
  ...
  /**
   * @mark setting viewer scale value to page-height
   * This helps view page better in horizontal scrolling mode
   */
  handleScaleValue = () => {
    if (this.viewer) {
    ...
    return (
      <div onPointerDown={this.onMouseDown}>
        <div
          ...
          style={{
            overflow: this.context?.state?.mode?.annot
              ? 'hidden'
              : 'auto'
          }}
